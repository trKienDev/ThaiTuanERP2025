...
{
	public sealed class ApprovalStepTemplateRepository : BaseRepository<ApprovalStepTemplate>, IApprovalStepTemplateRepository 
	{
		public ApprovalStepTemplateRepository(ThaiTuanERP2025DbContext dbContext, IConfigurationProvider configurationProvider) : base(dbContext, configurationProvider)
		{
		}
