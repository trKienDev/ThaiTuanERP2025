...
{
	public sealed  class ApprovalWorkflowInstanceRepository : BaseRepository<ApprovalWorkflowInstance>, IApprovalWorkflowInstanceRepository
	{
		public ApprovalWorkflowInstanceRepository(ThaiTuanERP2025DbContext dbContext, IConfigurationProvider configurationProvider) : base(dbContext, configurationProvider) { }

		public async Task<List<ApprovalWorkflowInstance>> ListByFilterAsync(string? documentType, Guid? documentId, WorkflowStatus? status, string? budgetCode, decimal? minAmount, decimal? maxAmount, CancellationToken cancellationToken)
		{
