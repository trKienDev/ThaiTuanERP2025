...
{
	public sealed class NotificationWriteRepository : BaseWriteRepository<AppNotification>, INotificationWriteRepository
	{
		public NotificationWriteRepository(ThaiTuanERP2025DbContext dbContext, IConfigurationProvider configurationProvider)
