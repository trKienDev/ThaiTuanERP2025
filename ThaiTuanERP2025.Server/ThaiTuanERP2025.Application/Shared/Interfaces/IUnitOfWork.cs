...
namespace ThaiTuanERP2025.Domain.Shared.Repositories
{
	public interface IUnitOfWork
	{
		...
		IOutgoingPaymentWriteRepository OutgoingPayments { get; }
		...
		IExpenseStepInstanceWriteRepository ExpenseStepInstances { get; }
		...
		ICommentMentionWriteRepository CommentMentions { get; }
