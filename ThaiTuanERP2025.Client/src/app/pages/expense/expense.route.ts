...
export const expenseRoutes: Routes = [
      {
            ...
            children: [
                  ...
                  { path: 'expense-payment-shell',  loadComponent: () => import('./pages/expense-payment-shell-page/expense-payment-shell-page.component').then((m) => m.ExpensePaymentShellPageComponent), },
