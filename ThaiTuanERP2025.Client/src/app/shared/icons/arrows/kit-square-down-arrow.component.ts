...
@Component({
      selector: 'kit-square-down-arrow',
      standalone: true,
      template: `
            <svg fill="#000000" [attr.width]="computedSize" [attr.height]="computedSize" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class="jam jam-arrow-square-down-f">
...
export class KitSquareDownArrowComponent extends KitBaseIcon {}