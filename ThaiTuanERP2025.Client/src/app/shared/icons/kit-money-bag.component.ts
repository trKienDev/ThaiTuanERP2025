...
@Component({
      selector: 'kit-money-bag-icon',
      standalone: true,
      template: `
            <svg [attr.width]="computedSize" [attr.height]="computedSize"  viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--noto" preserveAspectRatio="xMidYMid meet">
                  <g fill="none">
...
export class KitMoneyBagIconComponent extends KitBaseIcon {
